...
@author: ziliangdotme, Si Chen
Si Chen helps to fix the bug :)
...
#        redownload = kwargs['redownload']
        ...
        pattern = r'<img[^>]+src=\"(http://\w+\.staticflickr\.com/\w+/{id}\w+\.(jpg|png))[^>]*>'.format(id=id)
        print doc
